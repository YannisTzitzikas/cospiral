...
public class CoSpiExamples {
	...
	public static void veryBigExamples() throws InterruptedException {
		...
		ArrayList<Integer> syntheticValues = 
				SyntheticDataGenerator
			  	.DecreasingByPercentage(10*1000*1000+10, 4000, 10, 20); // size, maxsize, minsize, decreasePercentage // to be 1 million
		...
		/*CoSpi.visualize(syntheticValuesNormalized
				,conf, false,true,false,false,false);
		TimeUnit.SECONDS.sleep(1);
		CoSpi.clearOldData();*/
		
	  	CoSpi.visualize(SyntheticDataGenerator
	  		  	.DecreasingByPercentage(1000*1000, 4, 0, 30)
				,conf, false,true,false,false,false);
		TimeUnit.SECONDS.sleep(1);
		CoSpi.clearOldData();
	...
	public static void comparisonExamples() throws InterruptedException {
		...
		String[] fileNumericData = {"Resources/numericdata.csv","Resources/numericdata.csv","Resources/numericdata.csv","Resources/numericdata.csv","Resources/numericdata.csv"};		
		...
		CoSpi.loadDataFromSingleFileAndCompareFrequencies("Resources/persons.csv", columnsPersonData, 10, 50, conf, false, false);
		TimeUnit.SECONDS.sleep(1);
		CoSpi.clearOldData();
	}
	...
	public static void runAndOpenSVGExamples() {
		...
		try {
			SVGGenerator.createSVG(conf, CoSpi.rectangles, 5000, CoSpi.pic.image, "C:\\Users\\manos\\Desktop","SVGNew.html");
