...
/**
 *
 * @author Yannis Tzitzikas (yannistzitzik@gmail.com) It creates a synthetically
 * derived set of values. Various methods for producing decreasing sets of
 * values are supported.
 */
public class SyntheticDataGenerator {

    /**
     * It creates a decreasing by percentage set of values starting from the
     * maxSize Never returns a value less than minsize BUG: NEVER GOES TO 0
     *
     * @param size
     * @param maxsize
     * @param minsize
     ...
     * @return
     */
    static public ArrayList<Integer> DecreasingByPercentage(int size, int maxsize, int minsize,
    ...
    /**
     * It creates a decreasing set of integer values, as defined by a Power-Law
     * function with constants a and b Never returns a value less than minsize
     *
     * @param size
     * @param alpha
     * @param beta
    ...
    static public ArrayList<Integer> PowerLaw(int size, double alpha, double beta, int minSize) {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            System.out.println(
                    "SyntGenerator [PL]: " + i + " Added value: " + alpha + "/(" + i + "^" + beta + ")= " + nextVal);
